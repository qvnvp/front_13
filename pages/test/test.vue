					...
					<view class="page-view">
						<view class="class-item">
							...
							<view class="item-container">
								<view class="thumb-box" v-for="(item1, index1) in item.detail" :key="index1">
									<view class="item-menu-name">{{item1.name}}</view>
									<view>{{item1.content}}</view>
									<img :src="item1.pic" style="width: 100%; height: auto;" />
								</view>
							</view>
						</view>
					</view>
...
<template>
	<view class="u-wrap">
		<view style="margin: 20rpx">
			<u-search placeholder="请输入你想搜索的学院" :animation="true"></u-search>
		</view>
		<view style="margin: 10rpx 30rpx; height: 200rpx; width: 80%; border: 1px solid red; background-color: #f2f2f2; border-radius: 10rpx"></view>	
		<view class="u-menu-wrap">
			<scroll-view scroll-y scroll-with-animation class="u-tab-view menu-scroll-view" :scroll-top="scrollTop">
...
<script>
	...
	import Fuse from 'fuse.js';
	import 'vue-select/dist/vue-select.css'; // 引入 Vue Select 的样式文件
